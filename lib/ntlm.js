...
function createType3Message(type2Message, username, password, workstation, target) {
	...
	return createType3MessageFromHashedPassword(type2Message, username, lmHash, ntlmHash, workstation, target);
}

function createType3MessageFromHashedPassword(type2Message, username, lmHash, ntlmHash, workstation, target) {
	let dataPos = 52,
		buf = new Buffer(1024);
...
module.exports = {
	...
	decodeType2Message,
	createType3Message,
	createType3MessageFromHashedPassword
};
